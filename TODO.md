# To-do: planleggingsdokumenter før appbygging

Opprettet 18.09.2026 etter brukerens bestilling. Dette er den korte avkrysningslisten
...
- [ ] **Akseptansekriterier:** gjør kravene etterprøvbare med Gitt/Når/Så, inkludert
  suksess, ugyldig input, manglende innlogging og feil eier. Knytt dem til krav-ID. (F05/F12)
- [ ] **Forretningsregler:** avklar tidsperioder, tilgjengelighet, godkjenning, henting,
  retur og avbestilling, samt om betaling eller depositum inngår. (F06)
...
- [ ] **Testplan:** knytt kriteriene til enhetstester, integrasjonstester og E2E. Beskriv
  testdata og manuell kontroll av tastatur, mobilvisning og høy zoom. (F12, G13–G16)
...
Bruk denne listen til å spore når planleggingstemaene er gjennomgått. Kryss bare av når
resultatet finnes og er gjennomgått av dere begge; legg da til lenken til dokumentet.
Den detaljerte før-bygg-listen følger også senere oppsett og implementering, så et ferdig
planleggingspunkt her betyr ikke at tilhørende funksjon eller GitHub-oppsett er bygget.
